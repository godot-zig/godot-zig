...
var from_type: [@as(usize, C.GDEXTENSION_VARIANT_TYPE_VARIANT_MAX)]C.GDExtensionVariantFromTypeConstructorFunc = undefined;
var to_type: [@as(usize, C.GDEXTENSION_VARIANT_TYPE_VARIANT_MAX)]C.GDExtensionTypeFromVariantConstructorFunc = undefined;
...
fn getByGodotType(comptime T: type) Type {
    return switch (T) {
        Godot.String => C.GDEXTENSION_VARIANT_TYPE_STRING,
        Godot.Vector2 => C.GDEXTENSION_VARIANT_TYPE_VECTOR2,
        Godot.Vector2i => C.GDEXTENSION_VARIANT_TYPE_VECTOR2I,
        Godot.Rect2 => C.GDEXTENSION_VARIANT_TYPE_RECT2,
        Godot.Rect2i => C.GDEXTENSION_VARIANT_TYPE_RECT2I,
        Godot.Vector3 => C.GDEXTENSION_VARIANT_TYPE_VECTOR3,
        Godot.Vector3i => C.GDEXTENSION_VARIANT_TYPE_VECTOR3I,
        Godot.Transform2D => C.GDEXTENSION_VARIANT_TYPE_TRANSFORM2D,
        Godot.Vector4 => C.GDEXTENSION_VARIANT_TYPE_VECTOR4,
        Godot.Vector4i => C.GDEXTENSION_VARIANT_TYPE_VECTOR4I,
        Godot.Plane => C.GDEXTENSION_VARIANT_TYPE_PLANE,
        Godot.Quaternion => C.GDEXTENSION_VARIANT_TYPE_QUATERNION,
        Godot.AABB => C.GDEXTENSION_VARIANT_TYPE_AABB,
        Godot.Basis => C.GDEXTENSION_VARIANT_TYPE_BASIS,
        Godot.Transform3D => C.GDEXTENSION_VARIANT_TYPE_TRANSFORM3D,
        Godot.Projection => C.GDEXTENSION_VARIANT_TYPE_PROJECTION,

        Godot.Color => C.GDEXTENSION_VARIANT_TYPE_COLOR,
        Godot.StringName => C.GDEXTENSION_VARIANT_TYPE_STRING_NAME,
        Godot.NodePath => C.GDEXTENSION_VARIANT_TYPE_NODE_PATH,
        Godot.RID => C.GDEXTENSION_VARIANT_TYPE_RID,
        Godot.Object => C.GDEXTENSION_VARIANT_TYPE_OBJECT,
        Godot.Callable => C.GDEXTENSION_VARIANT_TYPE_CALLABLE,
        Godot.Signal => C.GDEXTENSION_VARIANT_TYPE_SIGNAL,
        Godot.Dictionary => C.GDEXTENSION_VARIANT_TYPE_DICTIONARY,
        Godot.Array => C.GDEXTENSION_VARIANT_TYPE_ARRAY,

        Godot.PackedByteArray => C.GDEXTENSION_VARIANT_TYPE_PACKED_BYTE_ARRAY,
        Godot.PackedInt32Array => C.GDEXTENSION_VARIANT_TYPE_PACKED_INT32_ARRAY,
        Godot.PackedInt64Array => C.GDEXTENSION_VARIANT_TYPE_PACKED_INT64_ARRAY,
        Godot.PackedFloat32Array => C.GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT32_ARRAY,
        Godot.PackedFloat64Array => C.GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY,
        Godot.PackedStringArray => C.GDEXTENSION_VARIANT_TYPE_PACKED_STRING_ARRAY,
        Godot.PackedVector2Array => C.GDEXTENSION_VARIANT_TYPE_PACKED_VECTOR2_ARRAY,
        Godot.PackedVector3Array => C.GDEXTENSION_VARIANT_TYPE_PACKED_VECTOR3_ARRAY,
        Godot.PackedColorArray => C.GDEXTENSION_VARIANT_TYPE_PACKED_COLOR_ARRAY,
        else => C.GDEXTENSION_VARIANT_TYPE_NIL,
    };
}
...
pub fn getVariantType(comptime T: type) Type {
    ...
    if (ret == C.GDEXTENSION_VARIANT_TYPE_NIL) {
        const ret1 = switch (@typeInfo(RT)) {
            .Struct => C.GDEXTENSION_VARIANT_TYPE_OBJECT,
            .Bool => C.GDEXTENSION_VARIANT_TYPE_BOOL,
            .Int, .ComptimeInt => C.GDEXTENSION_VARIANT_TYPE_INT,
            .Float, .ComptimeFloat => C.GDEXTENSION_VARIANT_TYPE_FLOAT,
...
pub fn as(self: Self, comptime T: type) T {
    ...
    if (tid == C.GDEXTENSION_VARIANT_TYPE_OBJECT) {
        ...
        to_type[C.GDEXTENSION_VARIANT_TYPE_OBJECT].?(@ptrCast(&obj), @ptrCast(&self.value));
